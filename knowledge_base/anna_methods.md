...
1. ถ้า dataset เป็น benchmark ที่มี reference → RESEARCH ก่อน แล้วส่ง KB ให้ Dana
2. บอก Dana ว่า: "เริ่มด้วย Pre-Cleaning Audit — schema + missing pattern + feature opportunities"
