...
key_features: Year, Value, is_return, is_cancellation, is_outlier
...
target kpi: Value
strongest evidence: quick scan of the cleaned table with 8 columns
...
Evidence: 105 rows and 8 columns after cleaning.
